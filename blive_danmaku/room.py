...
class Room(Thread):
    ...
    async def on_combo_send(self, event):
        ...
        #         'data':
        #         {
        #             'action': '投喂', 'batch_combo_id': 'batch:gift:combo_id:6992678:8739477:30607:1635836133.2648', 'batch_combo_num': 24, 'combo_id': 'gift:combo_id:6992678:8739477:30607:1635836131.4221',
        #             'combo_num': 24, 'combo_total_coin': 0, 'dmscore': 56, 'gift_id': 30607, 'gift_name': '小心心', 'gift_num': 0, 'is_show': 1,
        #             'medal_info': {'anchor_roomid': 0, 'anchor_uname': '', 'guard_level': 0, 'icon_id': 0, 'is_lighted': 1, 'medal_color': 9272486, 'medal_color_border': 9272486, 'medal_color_end': 9272486, 'medal_color_start': 9272486, 'medal_level': 12, 'medal_name': '德云色', 'special': '', 'target_id': 8739477},
    ...
    async def on_guard_buy(self, event):
        ...
        #             'guard_level': 3, 'num': 1, 'price': 198000, 'gift_id': 10003, 'gift_name': '舰长', 'start_time': 1635843126, 'end_time': 1635843126}}}
        print_msg(RTextList(
            self.get_room_prefix(),
            self.get_user_prefix(
    ...
    async def on_super_chat_message(self, event):
        ...
        #     'medal_info': {'anchor_roomid': 7777, 'anchor_uname': '老实憨厚的笑笑', 'guard_level': 0, 'icon_id': 0, 'is_lighted': 1, 'medal_color': '#5d7b9e', 'medal_color_border': 6126494, 'medal_color_end': 6126494, 'medal_color_start': 6126494, 'medal_level': 5, 'medal_name': '德云色', 'special': '', 'target_id': 8739477},
        #     'message': '好听，主播别害羞，继续继续', 'price': 30, 'rate': 1000, 'start_time': 1635839072, 'time': 60, 'token': '41648C03', 'trans_mark': 0, 'ts': 1635839072, 'uid': 3438425,
        #     'user_info': {'face_frame': '', 'guard_level': 0, 'is_main_vip': 1, 'is_svip': 0, 'is_vip': 0, 'level_color': '#61c05a', 'manager': 0, 'name_color': '#666666', 'title': '0', 'uname': '北枳南笙mazarine', 'user_level': 13}
        # }}}
        print_msg(RTextList(
            self.get_room_prefix(),
            self.get_user_prefix(
    ...
    async def on_live(self, event):
        ...
        #         'sub_session_key': '190125605077585777sub_time:1635850495', 'live_platform': 'pc_link', 'live_model': 0, 'roomid': 22744945
        #     }
        # }
        print_msg(RTextList(
            self.get_room_prefix(),
    ...
    async def on_entry_effect(self, event):
        ...
        #             'privilege_type': 3, 'copy_writing': '欢迎舰长 <%黑暗女王的泪%> 进入直播间', 'priority': 1, 'show_avatar': 1, 'effective_time': 2, 'web_basemap_url': '', 'web_effective_time': 0, 'web_effect_close': 0, 'web_close_time': 0, 'business': 1,
        #             'copy_writing_v2': '欢迎舰长 <%黑暗女王的泪%> 进入直播间', 'icon_list': [], 'max_delay_time': 7, 'trigger_time': 1635840589630651228, 'identities': 6
        #         }
        #     }
        # }
        pass
    ...
    async def on_interact_word(self, event):
        ...
        #             {'anchor_roomid': 57687, 'guard_level': 0, 'icon_id': 0, 'is_lighted': 0, 'medal_color': 1725515, 'medal_color_border': 12632256,
        #                 'medal_color_end': 12632256, 'medal_color_start': 12632256, 'medal_level': 22, 'medal_name': '判判', 'score': 50002362, 'special': '', 'target_id': 4191996},
        #             'identities': [1], 'is_spread': 0, 'msg_type': 1, 'roomid': 545068, 'score': 1635837793687, 'spread_desc': '', 'spread_info': '', 'tail_icon': 0, 'timestamp': 1635837793, 'trigger_time': 1635837792648484600,
    ...
    async def on_timeout(self, event):
        # TIMEOUT: 心跳响应超时
        pass
